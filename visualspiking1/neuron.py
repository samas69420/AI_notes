...
class neuron:
    ...
    def propagate(self):
        ...
        for element in neighbors:
            ncoords=element.coords
            rect=self.canvas.create_oval(x*100+11,y*100+11,x*100+19,y*100+19,fill="cyan")
            v=ncoords[0]-x,ncoords[1]-y
            v=3*v[0]/math.sqrt(v[0]**2+v[1]**2),3*v[1]/math.sqrt(v[0]**2+v[1]**2)
            dest=ncoords[0]*100,ncoords[1]*100
            synapse.spikes.append([rect,v[0],v[1],dest,self,element])
